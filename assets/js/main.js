...
var _user$project$Main$addFailOrCritLabel = F3(
	function (txt, clazz, hasHappened) {
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'is-invisible', _1: !hasHappened},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: clazz, _1: true},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$Main$countTwentiesInRoll = function (rolls) {
	return _elm_lang$core$List$length(
		A2(
			_elm_lang$core$List$filter,
			function (_p0) {
				var _p1 = _p0;
				return _elm_lang$core$Native_Utils.eq(_p1._1, 20);
			},
			rolls));
};
var _user$project$Main$countOnesInRoll = function (rolls) {
	return _elm_lang$core$List$length(
		A2(
			_elm_lang$core$List$filter,
			function (_p2) {
				var _p3 = _p2;
				return _elm_lang$core$Native_Utils.eq(_p3._1, 1);
			},
			rolls));
};
var _user$project$Main$renderCrit = function (model) {
	var hasCrit = _elm_lang$core$Native_Utils.cmp(
		_user$project$Main$countOnesInRoll(model.rolls),
		2) > -1;
	var hasFail = _elm_lang$core$Native_Utils.cmp(
		_user$project$Main$countTwentiesInRoll(model.rolls),
		2) > -1;
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Krit. Erfolg / Patzer'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Main$addFailOrCritLabel, 'krit. Erfolg', 'is-crit', hasCrit),
						_1: {
							ctor: '::',
							_0: A3(_user$project$Main$addFailOrCritLabel, 'gepatzt', 'is-fail', hasFail),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
	...
	function (value, trait, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				rolls: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: trait, _1: value},
					_1: model.rolls
				}
			});
	});
var _user$project$Main$getTrait = F2(
	function (trait, model) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (t) {
					return _elm_lang$core$Native_Utils.eq(t.trait, trait);
				},
				model.traits));
	});
var _user$project$Main$getTraitValue = F2(
	function (trait, model) {
		return A2(
		...
		F2(
			function (_p4, total) {
				...
				return total + A2(
					...
					A2(_user$project$Main$getTraitValue, _p5._0, model),
					_p5._1);
			}),
		0,
		model.rolls);
...
var _user$project$Main$extractTraitRolls = function (model) {
	return A2(
		...
		function (_p6) {
			...
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Main$traitLabel(_p7._0),
				A2(
					_elm_lang$core$Basics_ops['++'],
					': ',
...
var _user$project$Main$renderRollButton = F2(
	function (trait, rollEvent) {
				...
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Roll ', labelForTrait)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$renderFieldForTrait = F3(
	function (trait, traitValue, changeEvent) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('trait'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('label is-medium'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(labelForTrait),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
												...
												},
												{
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$placeholder(labelForTrait),
																_1: {
																	ctor: '::',
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: _elm_lang$html$Html_Attributes$value(
																				_elm_lang$core$Basics$toString(traitValue)),
																			_1: {ctor: '[]'}
																		}
																	}
																}
...
var _user$project$Main$CharacterTrait = F2(
	function (a, b) {
		return {trait: a, value: b};
	});
var _user$project$Main$updateTraitValue = F3(
	function (model, trait, value) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				traits: A2(
					_elm_lang$core$List$map,
					function (t) {
						return _elm_lang$core$Native_Utils.eq(t.trait, trait) ? A2(_user$project$Main$CharacterTrait, trait, value) : t;
					},
					model.traits)
			});
	});
...
var _user$project$Main$Ge = {ctor: 'Ge'};
var _user$project$Main$Mu = {ctor: 'Mu'};
var _user$project$Main$Kk = {ctor: 'Kk'};
var _user$project$Main$Ff = {ctor: 'Ff'};
var _user$project$Main$Ko = {ctor: 'Ko'};
var _user$project$Main$Kl = {ctor: 'Kl'};
var _user$project$Main$initialModel = {
	traits: {
		ctor: '::',
		_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Mu, 13),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Kl, 14),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$In, 14),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Ch, 15),
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Ff, 13),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Ge, 12),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Ko, 11),
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$CharacterTrait, _user$project$Main$Kk, 9),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		switch (_p8.ctor) {
			...
			case 'RollSingle':
				return {
					...
					_1: A2(
						...
						A2(_elm_lang$core$Random$int, 1, _p8._0))
				};
			case 'RolledSingle':
				return {
					ctor: '_Tuple2',
			...
			case 'Roll':
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$Main$Rolled(_p8._0),
						_user$project$Main$twentySidedDieGen)
				};
			case 'Rolled':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$addTraitRoll, _p8._1, _p8._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'RollTalent':
				...
				return {
					...
					_1: A2(
						_elm_lang$core$Random$generate,
						_user$project$Main$RolledTalent(_p8._0),
						threeDice)
				};
			case 'RolledTalent':
				var _p9 = _p8._0;
				...
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Main$addTalentRoll, zipped, _p9, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Change':
				return {
					...
					_0: A3(
						...
						model,
						_p8._0,
						_user$project$Main$parseIntWithDefault(_p8._1)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('DSA Compagnon'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
					...
					},
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Main$renderCrit(model),
									_1: {ctor: '[]'}
								}
							}
						}
