...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Trait":{"args":[],"tags":{"Ko":[],"Ge":[],"Ff":[],"Mu":[],"Kl":[],"In":[],"Kk":[],"Ch":[]}},"Main.Msg":{"args":[],"tags":{"Roll":["Main.Trait"],"RollTalent":["Main.Talent"],"ResetRolls":[],"Change":["Main.Trait","String"],"Rolled":["Main.Trait","Int"],"RollSingle":["Int"],"RolledTalent":["Main.Talent","List Int"],"RolledSingle":["Int"],"NoOp":[]}}},"aliases":{"Main.Talent":{"args":[],"type":"{ title : String, traits : List Main.Trait, value : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
